...
RSpec.describe Usual::Example1::Main do
  ...
  context "when `with` method is used" do
    describe "#enabled?" do
      subject(:perform) { described_class.with(**arguments).enabled? }
    ...
    describe "#disabled?" do
      subject(:perform) { described_class.with(**arguments).disabled? }
    ...
    describe "#enable" do
      subject(:perform) { described_class.with(**arguments).enable }
    ...
    describe "#disable" do
      subject(:perform) { described_class.with(**arguments).disable }
